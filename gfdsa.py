...
class Client(User):
    def __init__(self, username, password):
        ...
        self.catalog = [
            ...
            {"name": "Панадол", "price": 70},
            {"name": "Ибупрофен", "price": 80},
            {"name": "Нурофен", "price": 90},
            {"name": "Цитрамон", "price": 60},
            {"name": "Фенистил", "price": 120},
            {"name": "Лоперамид", "price": 55},
            {"name": "Мезим", "price": 110},
            {"name": "Рибоксин", "price": 130},
            {"name": "Каптоприл", "price": 75},
            {"name": "Амлодипин", "price": 85},
            {"name": "Амоксициллин", "price": 95},
            {"name": "Азитромицин", "price": 105},
            {"name": "Левомицетин", "price": 65},
            {"name": "Бисептол", "price": 100},
            {"name": "Нимесулид", "price": 55},
            {"name": "Флуконазол", "price": 70},
            {"name": "Глицин", "price": 45},
            {"name": "Линекс", "price": 120},
            {"name": "Ферромед", "price": 150},
            {"name": "Ацикловир", "price": 80},
            {"name": "Кетонал", "price": 90},
            {"name": "Преднизолон", "price": 85},
            {"name": "Диакарб", "price": 55},
            {"name": "Троксевазин", "price": 100},
            {"name": "Но-шпа", "price": 75},
            {"name": "Фломакс", "price": 95},
            {"name": "Колдрекс", "price": 110},
            {"name": "Кетоконазол", "price": 65},
            {"name": "Ламизил", "price": 105},
        ]
